{$\psi$}–C17 introduces hostile spirals, SUSY-ghost carriers, and firewall tuning. Identity Gradient Protocol (IGP) accepts converging spirals ($G(\psi)>0$) and routes diverging ones to the ESDR collapse routine.
