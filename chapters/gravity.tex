...
\paragraph{Offset–imbalance link.}
In ringdown windows, let $\overline{\Xi}=\langle|\psi_+|^2-|\psi_-|^2\rangle$.
A first–order perturbation of the lifted operator yields
$\Delta h_{\rm mem}\propto \beta_\Lambda\,\overline{\Xi}$ and
$\delta\omega_{220}/\omega_{220}=\alpha_\Lambda\,\overline{\Xi}+O(\overline{\Xi}^2)$,
consistent with Chap.~\ref{chap:predictions}.
